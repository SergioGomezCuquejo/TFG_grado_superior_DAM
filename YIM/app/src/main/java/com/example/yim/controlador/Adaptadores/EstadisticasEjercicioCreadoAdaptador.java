...
public class EstadisticasEjercicioCreadoAdaptador extends RecyclerView.Adapter<EstadisticasEjercicioCreadoAdaptador.EstadisticasViewHolder> {
    private ArrayList<TablaEjercicioCreado> ejerciciosUsuarios;
    private Context context;
    HashMap<String, String> musculosHM;

    public EstadisticasEjercicioCreadoAdaptador(Context context, ArrayList<TablaEjercicioCreado> ejerciciosUsuarios, HashMap<String, String> musculosHM) {
    ...
    public void onBindViewHolder(@NonNull EstadisticasViewHolder holder, int position) {
        TablaEjercicioCreado ejercicio = ejerciciosUsuarios.get(position);
